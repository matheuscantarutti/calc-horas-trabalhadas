        ...
        <div class="w-50 mx-auto m-5">
            <form class="form-horizontal w-50 mx-auto" action='turno/calcular' method='post' enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <input required class='form-control' type="time" name="hora_inicial" id="hora_inicial">
                </div>
                <div class="form-group">
                    <label  class='form-label' for="hora_final">Horário final</label>
                    <input required  class='form-control' type="time" name="hora_final" id="hora_final">
                </div>
